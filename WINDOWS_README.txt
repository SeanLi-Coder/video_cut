Local Video Cutter v1.10.5 — Windows 11 / RTX 5090 便携版使用方法
...
Get-FileHash .\LocalVideoCutter-Windows-RTX5090-v1.10.5.zip -Algorithm SHA256
Get-Content .\LocalVideoCutter-Windows-RTX5090-v1.10.5.zip.sha256
